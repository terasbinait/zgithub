			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgithub-display": {
								"semanticObject": "zgithub",
								"action": "display",
								"description": "Testing on Using GitHub",
								"title": "Using GitHub",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgithub",
									"url": sap.ui.require.toUrl("zgithub")
								}
							}
						}
					}
